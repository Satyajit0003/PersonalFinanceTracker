...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NotSufficeintMoneyException.class)
    public ResponseEntity<Map<String, Object>> handleNotSufficientMoneyException(NotSufficeintMoneyException ex) {
        Map<String, Object> response = Map.of(
                "message", ex.getMessage(),
                "status", HttpStatus.NOT_FOUND
        );
